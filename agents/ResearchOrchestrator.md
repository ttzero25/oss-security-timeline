...
The default verifier remains an offline container. A successful contrast is not proof of novelty: the collected GitHub/OSV snapshot is checked for likely duplicates and every generated draft states that broader human review is required. External submission is disabled and must be performed by a person.
